...
{
    internal class BrokenLinesScenario : Scenario
    {
        ...
        public BrokenLinesScenario(Store store, RefreshCallback callback, SettingsRepository repository) : base(store, callback)
        {
        ...
        public override void OnDraw(PaintEventArgs e, Form form)
        {
            ...
            controller.OnDraw(e);
            graphics.DrawPolygon(linePen, currentPoints.ToArray());
